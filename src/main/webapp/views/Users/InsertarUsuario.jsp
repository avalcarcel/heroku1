        ...
        <div class="col-md-6">
            <form role="form" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nick" placeholder="Insert your nickname here!" name="nick" size="30">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="mail"><i class="glyphicon glyphicon-envelope"></i>Email:</label>
                    <input type="text" class="form-control" id="mail" placeholder="Insert your email here!" name="mail" size="30">
                </div>
